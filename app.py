# -*- coding: utf-8 -*-
"""
Created on Tue Jun 27 13:56:37 2023
...
def tab1():
    ...
    st.title("CorpenPremier KK Summary")
...
def tab5():
     ...
     simulations = st.selectbox("Number of Simulations (n)", [1,10,100,200, 500, 1000])
